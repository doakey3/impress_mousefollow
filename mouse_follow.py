...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.thread = Mover()
        self.thread.signal.connect(self.moveMe)
        self.thread.start()
    ...
    def moveMe(self):
        ...
        # These are the different configurations I've seen
        impress_no_notes_ = [225, 849, 48, 1150]
        impress_notes = [44, 409, 46, 696]
        windows_powerpoint = [149, 823, 60, 1258]
        
        preview_top, preview_bottom, preview_left, preview_right = impress_notes
    ...
    def keydown(self, event):
        if event.Key == 'Lcontrol' or event.Key == 'Control_L':
            self.show()
        return 1
